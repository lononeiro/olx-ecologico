...
export function ResetPasswordClient({ token, email }: Props) {
            ...
            <>
              <div className="a1" style={{ marginBottom: "2.5rem" }}>
                ...
                <p style={{ color: "var(--auth-muted)", fontSize: ".9rem" }}>
                  Conta: <span style={{ color: "var(--auth-text)", fontWeight: 500 }}>{email}</span>
                </p>
              </div>
              ...
              <div className="a3" style={{ marginTop: "1.5rem", textAlign: "center" }}>
                <TransitionLink href="/forgot-password" style={{ color: "var(--auth-soft)", fontSize: ".85rem", textDecoration: "none" }}>
                  Solicitar novo link
                </TransitionLink>
              </div>
            </>
