...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(false);
    if (res?.error) { setErro("Email ou senha invalidos."); return; }
  ...
  const inputStyle = (name: string): React.CSSProperties => ({
    ...
    borderRadius: "12px", padding: ".85rem 1rem", color: "var(--auth-text)",
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: "0 0 45%", background: "linear-gradient(145deg,var(--auth-panel),var(--auth-panel-2))",
      ...
      >
        ...
        <div style={{ position:"relative", textAlign:"center", zIndex:1 }}>
          <div style={{ fontSize:"4rem", marginBottom:"1.5rem", lineHeight:1, color: "var(--auth-accent)" }}>♻</div>
          <h2 style={{ fontFamily:"var(--font-display)", fontSize:"2.2rem",
            color:"var(--auth-text)", fontWeight:700, lineHeight:1.2, marginBottom:"1rem" }}>
            Bem-vindo<br/>de volta.
          </h2>
          <p style={{ color:"var(--auth-muted)", fontSize:".95rem", lineHeight:1.7, maxWidth:"280px" }}>
            Acesse sua conta e continue contribuindo para um mundo mais sustentavel.
          </p>

          <div style={{ display:"flex", gap:"2rem", justifyContent:"center",
            marginTop:"3rem", paddingTop:"2rem",
            borderTop:"1px solid var(--auth-border-soft)" }}>
          </div>
        </div>
      </div>
      ...
      <div style={{ flex:1, display:"flex", flexDirection:"column",
        ...
        <div style={{ position:"absolute", top:"1.5rem", right:"2rem", display: "flex", alignItems: "center", gap: ".7rem" }}>
          <ThemeToggle compact />
          <TransitionLink href="/" style={{ color:"var(--auth-muted)", fontSize:".85rem",
        ...
        <div style={{ width:"100%", maxWidth:"400px" }}>
          <div className="a1" style={{ marginBottom:"2.5rem" }}>
            <div style={{ fontFamily:"var(--font-display)", fontSize:"2rem",
              color:"var(--auth-text)", fontWeight:700, marginBottom:".4rem" }}>
              Entrar
            </div>
          ...
          {erro && (
            <div className="a2" style={{ background:"var(--auth-danger-bg)",
              border:"1px solid var(--auth-danger-border)", borderRadius:"12px",
              padding:".85rem 1rem", color:"var(--auth-danger)", fontSize:".88rem",
          ...
          <form onSubmit={handleSubmit} style={{ display:"flex", flexDirection:"column", gap:"1.2rem" }}>
            <div className="a2">
              <label style={{ display:"block", color:"var(--auth-soft)", fontSize:".8rem",
          ...
          <div className="a5">
            <TransitionLink href="/register"
              style={{ display:"block", textAlign:"center",
                border:"1px solid var(--auth-border)", borderRadius:"12px",
                padding:".9rem", color:"var(--auth-accent)", textDecoration:"none",
                fontSize:".9rem", transition:"all .2s",
                background:"var(--auth-surface)" }}>
              Criar uma conta gratis
            </TransitionLink>
          </div>
        </div>
      </div>
